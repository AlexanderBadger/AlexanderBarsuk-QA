...
public class AreaPerimeterCalc {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Радиус не может быть <= 0" + "\n");
        }
        ...
        try {
            ...
            System.out.println(e.getMessage());
            System.out.println("Сторона треугольника не может быть <= 0" + "\n");
        }
        ...
        try {
            ...
            System.out.println(e.getMessage());
            System.out.println("Сторона прямоугольника не может быть <= 0" + "\n");
        }
    }
}